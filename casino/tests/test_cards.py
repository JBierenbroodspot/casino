...
deck.shuffle_cards()
print("random card w/o discard:", deck.pick_random_card().show())
print("random card w/ discard:", deck.pick_top_card(True).show())
print("deck length:", len(deck.cards))
print("discarded cards:", deck.discarded_cards)
print("shuffle including random cards:", deck.shuffle_cards(True))
